...
PROGRAM RDF
  USE parameters2, ONLY : nframes, stride
  IMPLICIT NONE
  INTEGER :: frame
...
SUBROUTINE INITIALIZE
  USE parameters2, ONLY : natoms,pos, atype, number_density, &
...
SUBROUTINE REMOVE_EQUIL
  USE parameters2, ONLY : natoms, nframes, nequil
  IMPLICIT NONE
  INTEGER                    :: iframe
...
SUBROUTINE READ_ATOM
  ...
  USE parameters2, ONLY : pos, natoms, atype, box
  IMPLICIT NONE
...
SUBROUTINE COMPUTE_RDF
  USE parameters2, ONLY : natoms, pos, ind_rdf, box, &
...
SUBROUTINE PRINT_RESULTS
  USE parameters2, ONLY : nhist, gofr, maxr, number_density, &
