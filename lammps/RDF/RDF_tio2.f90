...
SUBROUTINE INITIALIZE
  USE parameters, ONLY : natoms,pos, atype, number_density, &
                         ...
                         box, ind_rdf, maxr, atype, stride, nrdf
  IMPLICIT NONE
  INTEGER                    :: i
...
SUBROUTINE COMPUTE_RDF
  USE parameters, ONLY : natoms, pos, ind_rdf, box, nrdf, &
...
SUBROUTINE PRINT_RESULTS
  ...
  number_density = float(nrdf) * float(N)
