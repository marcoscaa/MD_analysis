...
SUBROUTINE INITIALIZE
  USE histogram,  ONLY : post, msd, stride, typmsd, tcorr
...
SUBROUTINE MSD_CORR
  ...
  USE histogram,  ONLY : msd, post, stride, tcorr
...
SUBROUTINE ASSIGN_POS ( frame )
  ...
  DO iat=1,natoms
    ...
    IF ( TRIM(atype(iat))==TRIM(typmsd) ) THEN 
...
SUBROUTINE PRINT_RESULTS 
  ...
  DO i = 0,tcorr-1
      ...
      write(2,fmt = '(E18.8,3X,*(E15.8,3X))'), dble(i)*tconst, msd(i+1)
